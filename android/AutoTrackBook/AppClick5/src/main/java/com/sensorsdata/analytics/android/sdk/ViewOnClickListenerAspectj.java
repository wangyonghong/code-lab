...
public class ViewOnClickListenerAspectj {
     ...
     * @param joinPoint JoinPoint
     */
    @After("execution(@com.sensorsdata.analytics.android.sdk.SensorsDataTrackViewOnClick * *" +
        "(android.view.View))")
     ...
     * @param joinPoint JoinPoint
     */
    @After("execution(* android.content.DialogInterface.OnClickListener.onClick(android.content" +
        ".DialogInterface, int))")
    ...
    /**
     * 支持 DialogInterface.OnMultiChoiceClickListener.onClick(android.content.DialogInterface,
     * int, boolean)
     *
     * @param joinPoint JoinPoint
     */
    @After("execution(* android.content.DialogInterface.OnMultiChoiceClickListener.onClick" +
        "(android.content.DialogInterface, int, boolean))")
    ...
    /**
     * 支持 CompoundButton.OnCheckedChangeListener.onCheckedChanged(android.widget.CompoundButton,
     * boolean)
     *
     * @param joinPoint JoinPoint
     */
    ...
    /**
     * 支持 RatingBar.OnRatingBarChangeListener.onRatingChanged(android.widget.RatingBar,float,
     * boolean)
     *
     * @param joinPoint JoinPoint
     */
    @After("execution(* android.widget.RatingBar.OnRatingBarChangeListener.onRatingChanged" +
     ...
     * @param joinPoint JoinPoint
     */
    @After("execution(* android.widget.SeekBar.OnSeekBarChangeListener.onStopTrackingTouch" +
    ...
    /**
     * 支持 AdapterView.OnItemSelectedListener.onItemSelected(android.widget.AdapterView,android
     * .view.View,int,long)
     *
     * @param joinPoint JoinPoint
     */
    @After("execution(* android.widget.AdapterView.OnItemSelectedListener.onItemSelected(android" +
        ".widget.AdapterView,android.view.View,int,long))")
    public void onItemSelectedAOP(final JoinPoint joinPoint) {
        android.widget.AdapterView adapterView =
            (android.widget.AdapterView) joinPoint.getArgs()[0];
    ...
    /**
     * 支持 AdapterView.OnItemClickListener.onItemClick(android.widget.AdapterView,android.view
     * .View,int,long)
     *
     * @param joinPoint JoinPoint
     */
    @After("execution(* android.widget.AdapterView.OnItemClickListener.onItemClick(android.widget" +
