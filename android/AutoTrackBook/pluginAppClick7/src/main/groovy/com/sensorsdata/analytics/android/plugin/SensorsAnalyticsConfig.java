...
public class SensorsAnalyticsConfig {
    ...
    static {
        ...
        sInterfaceMethods.add(new SensorsAnalyticsMethodCell("android.content" +
            ".DialogInterface$OnClickListener",
            "onClick(Landroid/content/DialogInterface;I)V", 1, 2));
        sInterfaceMethods.add(new SensorsAnalyticsMethodCell("android.content" +
            ".DialogInterface$OnMultiChoiceClickListener",
            "onClick(Landroid/content/DialogInterface;IZ)V", 1, 3));
        sInterfaceMethods.add(new SensorsAnalyticsMethodCell("android.widget" +
    ...
    public static SensorsAnalyticsMethodCell isMatched(Set<String> interfaceList,
                                                       String methodDesc) {
