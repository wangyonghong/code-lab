...
class _WeatherInfoState extends State<WeatherInfo> {
  ...
  Column buildForecast(weatherData){
    ...
    for (var i = 0; i < weatherData.data.foreCast.foreCastItems.length; i++) {
      ...
      widgets.add(Text("日出：${weatherData.data.foreCast.foreCastItems[i].sunrise}"));
      widgets.add(Text("日落：${weatherData.data.foreCast.foreCastItems[i].sunset}"));
