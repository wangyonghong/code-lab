...
public class JvmUtil {
    ...
    public static void main(String... args) {
        ...
        Print.tcfo("ascending：" + getAddresses((Object) ascending));
        Print.tcfo("descending：" + getAddresses((Object) descending));
        Print.tcfo("shuffled：" + getAddresses((Object) shuffled));
